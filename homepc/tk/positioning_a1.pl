...
sub come_window {
    ...
    $balloon->attach($north_btn, 
		     -balloonmsg => "きた",
		     -statusmsg => "-side=>\"top\",-expand=>1,-anchor=>\"s\"",
    ...
    $balloon->attach($south_btn, 
		     -balloonmsg => "みなみ",
		     -statusmsg => "-side=>\"bottom\",-expand=>1,-anchor=>\"n\"",
		     -balloonposition => 'mouse',
	);
    ...
    $balloon->attach($west_btn, 
		     -balloonmsg => "にし",
		     -statusmsg => "-side=>\"left\",-expand=>1,-anchor=>\"e\"",
		     -balloonposition => 'mouse',
	);
    ...
    $balloon->attach($exit_btn, 
		     -balloonmsg => "しゅうりょう",
		     -statusmsg => "-side=>\"left\",-expand=>0,-ipadx=>20,-ipady=>20",
		     -balloonposition => 'mouse',
	);
	...
	)->pack(-side => "right", -expand => 1, -anchor => "w");
    $balloon->attach($east_btn, 
		     -balloonmsg => "ひがし",
		     -statusmsg => "-side=>\"right\",-expand=>1,-anchor=>\"w\"",
		     -balloonposition => 'mouse',
	);
    MainLoop;
}
