...
my @font_families = ("Helvetica", "Times");
my @font_sizes = qw(12 18 24 36 48);
...
my $フォント_menu = $menubar->entrycget('フォント', -menu);
my $ファミリ_menu = $フォント_menu->entrycget('ファミリ', -menu);
my $ファミリ_var = $ファミリ_menu->entrycget('Times', -variable);
$$ファミリ_var = 'Times';
my $サイズ_menu = $フォント_menu->entrycget('サイズ', -menu);
my $サイズ_var = $サイズ_menu->entrycget('24', -variable);
$$サイズ_var = '24';
...
sub フォント_menuitems {
    [
     ...
     ['~ファミリ',
      [
       map ['radiobutton', $_], @font_families,
      ],
     ],
     ['~サイズ',
      [
       map ['radiobutton', $_], @font_sizes,
      ],
     ],
    ];
}
